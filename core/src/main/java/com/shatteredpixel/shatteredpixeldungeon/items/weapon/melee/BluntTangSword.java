...
public class BluntTangSword extends MeleeWeapon {
	
	{
		image = ItemSpriteSheet.BROKENTANGSWORD;
	...
	public int max(int lvl) {
		return  7*(tier - 1) +    //14 base, down from 20	最大伤害从15降低到12
